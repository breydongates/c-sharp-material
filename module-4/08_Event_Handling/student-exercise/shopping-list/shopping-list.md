...
When a user clicks on an item in the shopping list, it should be marked complete. To do so, add the `completed` class to the list item and the icon.

### Mark item incomplete

When a user double clicks on an item in the shopping list, it should be marked incomplete. To do so, remove the `completed` class to the list item and the icon.
