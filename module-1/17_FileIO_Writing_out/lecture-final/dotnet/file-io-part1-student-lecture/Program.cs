...
namespace FileInputLecture
{
    class Program
    {
        ...
        public static string GetReadmeDir()
        {
            ...
            DirectoryInfo netcoreappDir = Directory.GetParent(dir);
            DirectoryInfo binDir = Directory.GetParent(netcoreappDir.FullName);
            DirectoryInfo codeDir = Directory.GetParent(binDir.FullName);
            DirectoryInfo readmeDir = Directory.GetParent(codeDir.FullName);
